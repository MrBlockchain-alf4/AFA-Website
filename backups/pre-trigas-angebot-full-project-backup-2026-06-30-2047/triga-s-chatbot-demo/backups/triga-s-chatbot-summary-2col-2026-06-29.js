...
/* ─── Summary 2-col compact grid ── */
.tgs-bk-conf-2col{display:grid;grid-template-columns:1fr 1fr;gap:3px 10px;}
.tgs-bk-conf-2col-full{grid-column:1/-1;}
.tgs-bk-conf-cell{padding:3px 0;display:flex;flex-direction:column;gap:2px;}
.tgs-bk-conf-cell-lbl{font-size:9px;font-weight:700;color:#7090B0;text-transform:uppercase;letter-spacing:.08em;}
.tgs-bk-conf-cell-val{font-size:11.5px;font-weight:700;color:#071627;word-break:break-word;}
