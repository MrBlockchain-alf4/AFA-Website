...
.tgs-bk-conf-2col{display:grid;grid-template-columns:1fr 1fr;gap:6px 6px;}
.tgs-bk-conf-2col-full{grid-column:1/-1;}
.tgs-bk-conf-cell{
  padding:8px 10px;display:flex;flex-direction:column;gap:3px;
  background:#EDF4FB;border:1px solid #BDD4E8;border-radius:8px;
}
.tgs-bk-conf-cell-lbl{font-size:9px;font-weight:700;color:#7A97B4;text-transform:uppercase;letter-spacing:.09em;}
.tgs-bk-conf-cell-val{font-size:13px;font-weight:600;color:#0C2238;word-break:break-word;line-height:1.3;}
