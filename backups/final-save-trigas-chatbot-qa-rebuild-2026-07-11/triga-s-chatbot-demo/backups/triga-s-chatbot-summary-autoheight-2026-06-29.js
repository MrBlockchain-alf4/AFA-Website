...
.tgs-bk-conf-2col{display:grid;grid-template-columns:1fr 1fr;gap:5px 12px;}
.tgs-bk-conf-2col-full{grid-column:1/-1;}
.tgs-bk-conf-cell{padding:4px 0;display:flex;flex-direction:column;gap:3px;}
.tgs-bk-conf-cell-lbl{font-size:9.5px;font-weight:700;color:#7090B0;text-transform:uppercase;letter-spacing:.08em;}
.tgs-bk-conf-cell-val{font-size:12.5px;font-weight:700;color:#071627;word-break:break-word;}
