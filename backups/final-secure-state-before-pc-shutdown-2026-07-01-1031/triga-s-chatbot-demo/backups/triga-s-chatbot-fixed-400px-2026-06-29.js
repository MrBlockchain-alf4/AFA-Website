...
/* ─── Calendar body ── */
.tgs-bk-body{flex:1;overflow:hidden;padding:10px 12px 6px;}
...
/* ─── Confirm body ── */
.tgs-bk-conf-body{flex:1;overflow:hidden;padding:8px 12px 4px;}
.tgs-bk-conf-section{margin-bottom:6px;}
...
.tgs-bk-sec-lbl{
  ...
  flex-shrink:0;font-size:11px;min-width:55px;
}
.tgs-bk-sec-val{
  color:#071627;font-weight:700;text-align:right;
  word-break:break-word;font-size:11.5px;
}
