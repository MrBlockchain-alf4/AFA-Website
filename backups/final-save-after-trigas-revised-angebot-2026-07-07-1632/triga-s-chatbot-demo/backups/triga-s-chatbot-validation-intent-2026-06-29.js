  ...
  function inpEmail(placeholder, onSubmit){
    ...
    const go=()=>{
      ...
      if(!isValidEmail(v)){
        ...
        $inp.value=''; $inp.type='email'; setTimeout(()=>$inp.focus(),50); return;
      }
      usr(v); onSubmit(v);
    };
    $snd.onclick=go;
  ...
  function inpPhone(placeholder, onSubmit){
    ...
    const go=v=>{
      ...
      if(!isValidPhone(raw)){
        ...
        $inp.value=''; $inp.type='tel'; setTimeout(()=>$inp.focus(),50); return;
      }
  ...
  function showMenu(){
    ...
    setTimeout(()=>{
      ...
      const fallback=()=>{
        ...
        if(intent==='booking'){
          showTyping(); setTimeout(()=>{ hideTyping(); bot('Gerne. Ich helfe Ihnen bei der Terminvereinbarung.'); setTimeout(()=>bookStart(),600); },1050);
        } else if(intent==='reschedule'){
          showTyping(); setTimeout(()=>{ hideTyping(); bot('Gerne. Ich helfe Ihnen dabei, Ihren Termin zu verschieben.'); setTimeout(()=>findStart('reschedule'),600); },1050);
        } else if(intent==='cancel'){
          showTyping(); setTimeout(()=>{ hideTyping(); bot('Natürlich. Ich helfe Ihnen dabei, Ihren Termin zu stornieren.'); setTimeout(()=>findStart('cancel'),600); },1050);
