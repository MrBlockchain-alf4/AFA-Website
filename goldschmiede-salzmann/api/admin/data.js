...
// so this doesn't hard-break before Supabase is configured. Shares the same
// `website_data` table as the other client sites — a separate CLIENT_ID
// row, not a separate Supabase project.
const fs = require('fs');
